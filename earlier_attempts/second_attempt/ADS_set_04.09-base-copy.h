...
public:
    ...
    reference operator*() const {
        ////////////////
        std::cerr << "Accessing element: bucket_index=" << bucket_index

<< ", element_index=" << element_index

<< ", element=" << set->directory.buckets[bucket_index]->elements[element_index] << std::endl;
        ///////////////
        return set->directory.buckets[bucket_index]->elements[element_index];
    }
 ...
 std::cerr << "Increment: bucket_index=" << bucket_index
<< ", element_index=" << element_index << std::endl;
    ...
    std::cerr << "Post-Increment: bucket_index=" << bucket_index
<< ", element_index=" << element_index << std::endl;
        return *this;
    }
    ...
    /* void skip() {
        size_type size = 1 << set->directory.global_depth;
        //// DEBUG STATEMENT ////////// DEBUG STATEMENT ////////// DEBUG STATEMENT //////
        std::cout << "Starting skip, bucket_index: " << bucket_index << ", element_index: " << element_index << std::endl; 
        //// DEBUG STATEMENT ////////// DEBUG STATEMENT ////////// DEBUG STATEMENT //////
        if (!visited) return;
        while (bucket_index < size) {
            if (element_index >= set->directory.buckets[bucket_index]->count || visited[bucket_index]) {
        ...
        //// DEBUG STATEMENT ////////// DEBUG STATEMENT ////////// DEBUG STATEMENT //////
        std::cout << "Ending skip, bucket_index: " << bucket_index << ", element_index: " << element_index << std::endl;
        //// DEBUG STATEMENT ////////// DEBUG STATEMENT ////////// DEBUG STATEMENT //////
    } */
...
size_type size = 1 << set->directory.global_depth;
/////////////////////
std::cerr << "Starting skip: bucket_index=" << bucket_index
...
size_type local_depth = set->directory.buckets[bucket_index]->local_depth;

if (element_index < set->directory.buckets[bucket_index]->count && !visited[bucket_index]) {

return; // Valid element found, return early

}

// Mark all directory entries that reference this bucket

for (size_t j = bucket_index; j < size; j += (1 << local_depth)) {
